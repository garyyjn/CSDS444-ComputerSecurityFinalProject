...
class xRsa(object):
    ...
    def __init__(self):
        print(
            "This is the class xRsa! According to RSA theory, use Python to realize the encryption and decryption of this algorithm")
...
if __name__ == '__main__':
   ...
   # print("cipher text:" + str(cipher))
    ...
    plaintext = t.decrptyMsg(22554085511684216828279451509,10593657044881372262777855993,98033959580682721309718179717)
